        ...
        <div class="row">
            <div class="col">
              ...
              <div class="card-header">
                <h3 class="card-title"><router-link to="/task/add" ><button class="btn btn-primary">Add Task</button></router-link></h3>
              </div>
              ...
              <div class="card-body">
                ...
                <table v-if="tasks.values.length==0"   class="table table-bordered">
                  ...
                  <tbody v-if="isloading">
                     <td colspan="8" style="height: 200px; align-items: center; text-align: center; justify-content: center; background-color:aliceblue;" ><h5>Loading...</h5></td>
                  </tbody>
               <tbody    v-for="task in tasks.slice(page,page+5)">
                    ...
                    <tr  >
                        ...
                        <td >{{ task.budget }}</td>
                        <td>{{ task.status }}</td>
                        <td :id="task.id" style="width: 20px;" class=" editTask ">
                          
                                      
                                     <button :id="task.id" @click="editTask"  class="btn btn-light"><i :id="task.id" class="fas fa-edit"></i>
</button>
                                  
                                      
                        </td>
                         <td style="width: 20px;"  class=" deleteTask " >
                         
                                      <router-link class="" to="/task">
                                     <button @click="handgleDelete(task.id)"   class="btn btn-light"><i class="fas fa-trash"></i>
</button>
                                     </router-link> 
